...
for column in datetime_columns:
    try:
        ...
        print(f"Value at position 72: {all_df[column].iloc[72]}")
...
with col1:
    ...
    ax.set_title("Total Order per Bulan", loc="center", fontsize=20)
...
with col2:
    ...
    ax.set_title("Total Revenue per Bulan", loc="center", fontsize=20)
    ax.tick_params(axis='y', labelsize=20)
    ax.tick_params(axis='x', labelsize=15, rotation=45)
    st.pyplot(fig)
...
# menampilkan produk paling banyak dan paling sedikit disukai oleh pelanggan
st.subheader("Produk Paling Banyak dan Paling Sedikit disukai")
